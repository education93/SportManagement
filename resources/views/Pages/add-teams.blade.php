                                        ...
                                        <form action="/add/team" method="post" class="tg-commentform help-form" id="tg-commentform" enctype="multipart/form-data">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    <input type="text" required="" placeholder="Team Name*" class="form-control" style="height:35px;" name="name">
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" required="" placeholder="Team Contact*" class="form-control" style="height:35px;" name="phone">
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" required="" placeholder="Team General Email*" class="form-control" style="height:35px;" name="email">
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" required="" placeholder="Physical Address*" class="form-control" style="height:35px;" name="address">
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" required="" placeholder="Team Owner*" class="form-control" style="height:35px;" name="manager">
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" required="" placeholder="Team Couch*" class="form-control" style="height:35px;" name="couch">
                                                </div>
                                                ...
                                                <div class="custom-file mb-3">
                                                    <input type="file" class="custom-file-input" id="customFile" name="home_kit">
                                                    <label class="custom-file-label" for="customFile">Upload Home Kit</label>
                                                </div>
                                                <div class="custom-file mb-3">
                                                    <input type="file" class="custom-file-input" id="customFile" name="away_kit">
                                                    <label class="custom-file-label" for="customFile">Upload Away Kit</label>
                                                </div>
                                                
                                                <div class="form-group">
                                                    <textarea required placeholder="About the Team*" style="height: 100px;" name="about"></textarea>
                                                </div>
                                                <div class="form-group">
