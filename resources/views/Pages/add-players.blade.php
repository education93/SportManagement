                                    ...
                                    <div class="col-md-7 col-sm-12 col-xs-12">
                                        <form action="#" method="post" class="tg-commentform help-form" id="tg-commentform">
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    <input type="text" required="" placeholder="Province of Birth*" class="form-control" style="height:35px;" name="province">
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" required="" placeholder="Home Town*" class="form-control" style="height:35px;" name="town">
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" required="" placeholder="Country of Birth*" class="form-control" style="height:35px;" name="country">
                                                </div>
                                                <div class="custom-file mb-3">
                                                    <input type="file" class="custom-file-input" id="customFile" name="player_image">
